...
### Primary Domain
🌐 **https://bonds n beyond.2men.co**

### Vercel URLs
- https://bonds n beyond29sep2025.vercel.app
- https://bonds n beyond29sep2025-chatgptnotes-6366s-projects.vercel.app
- https://bonds n beyond29sep2025-b5d0g9yd6-chatgptnotes-6366s-projects.vercel.app
...
1. **Payment Integration** 💳
   ...
   - Voucher system (FOUNDER50, WELCOME20, BONDS N BEYOND10, EARLY100)

2. **UI Fixes** ✨
   - Removed duplicate Bonds N Beyond logo from all NFC pages
...
1. Visit: https://bonds n beyond.2men.co
2. Register/Login
3. Configure NFC card: https://bonds n beyond.2men.co/nfc/configure
4. Checkout: https://bonds n beyond.2men.co/nfc/checkout
5. Payment: https://bonds n beyond.2men.co/nfc/payment
   - Test Card: `4242 4242 4242 4242`
   - Test UPI: Scan QR code
   - Test Voucher: `FOUNDER50`
6. Success: https://bonds n beyond.2men.co/nfc/success
7. Profile Builder: https://bonds n beyond.2men.co/profiles/builder

### Key Pages to Test
- ✅ Landing: https://bonds n beyond.2men.co/landing
- ✅ Configure: https://bonds n beyond.2men.co/nfc/configure
- ✅ Checkout: https://bonds n beyond.2men.co/nfc/checkout
- ✅ Payment: https://bonds n beyond.2men.co/nfc/payment
- ✅ Success: https://bonds n beyond.2men.co/nfc/success
- ✅ Profile Builder: https://bonds n beyond.2men.co/profiles/builder
- ✅ Dashboard: https://bonds n beyond.2men.co/profiles/dashboard
