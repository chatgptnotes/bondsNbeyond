# Bonds N Beyond NFC User Flow Documentation
...
- **Next**: Redirects to `/welcome-to-bondsnbeyond`

### 4. **Welcome Onboarding** (`/welcome-to-bondsnbeyond`)
...
/register → /verify-register → /account → /welcome-to-bondsnbeyond →
...
| Account | `/account` | User dashboard | `/welcome-to-bondsnbeyond` (first time) |
| Welcome | `/welcome-to-bondsnbeyond` | Collect profile info | `/verify-mobile` |
