...
test.describe('Product Selection Page - Basic Loading', () => {
  test('should load the page successfully with all elements', async ({ page }) => {
    ...
    // Check page title
    await expect(page.locator('h1')).toContainText('Choose Your Bonds N Beyond Experience');

    // Check logo
    await expect(page.locator('img[alt="Bonds N Beyond"]')).toBeVisible();
  ...
  test('should display all product titles correctly', async ({ page }) => {
    ...
    await expect(page.locator('text=Physical NFC Card + Bonds N Beyond App')).toBeVisible();
    await expect(page.locator('text=Digital Profile + Bonds N Beyond App')).toBeVisible();
...
test.describe('Product Selection Page - Card Selection by Clicking', () => {
  test('should select card when clicking anywhere on Option 1 (Physical NFC)', async ({ page }) => {
    ...
    const physicalCard = page.locator('div').filter({ hasText: 'Physical NFC Card + Bonds N Beyond App' }).first();
  ...
  test('should select card when clicking anywhere on Option 2 (Digital + App)', async ({ page }) => {
    ...
    const digitalAppCard = page.locator('div').filter({ hasText: 'Digital Profile + Bonds N Beyond App' }).first();
...
test.describe('Product Selection Page - Accessibility', () => {
  ...
  test('should have alt text on logo image', async ({ page }) => {
    ...
    const logo = page.locator('img[alt="Bonds N Beyond"]');
