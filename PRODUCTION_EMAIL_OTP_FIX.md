...
**Usage**:
```bash
curl https://bonds n beyond7oct2025.vercel.app/api/test-smtp-production
```
...
**Note**: `EMAIL_FROM` ko simple format me rakha (without "Bonds N Beyond NFC <>") because code automatically format kar deta hai.
...
```bash
curl -X POST https://bonds n beyond7oct2025.vercel.app/api/send-email-otp \
...
- **Main URL**: https://bonds n beyond7oct2025.vercel.app
- **Test Endpoint**: https://bonds n beyond7oct2025.vercel.app/api/test-smtp-production
- **Login Page**: https://bonds n beyond7oct2025.vercel.app/login
- **Vercel Dashboard**: https://vercel.com/chatgptnotes-6366s-projects/bonds n beyond7oct2025
...
**Date**: October 7, 2025
**Project**: bonds n beyond7oct2025
