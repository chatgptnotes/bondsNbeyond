...
3. Add new variable:
   - **Name:** `COOKIE_DOMAIN`
   - **Value:** `.bonds n beyond.ai`
   - **Environment:** Production

4. Click "Save"
5. Redeploy if needed

**Important:** The leading dot (`.bonds n beyond.ai`) is required for subdomain support.
...
# Ensure COOKIE_DOMAIN=.bonds n beyond.ai is set for Production
```
...
2. **Test Desktop Browser - Chrome**
   - [ ] Open https://bondsnbeyond.ai in Chrome
   - [ ] Register/Login
...
3. **Test Desktop Browser - Safari**
   - [ ] Open https://bondsnbeyond.ai in Safari
   - [ ] Login/Register
   - [ ] Test Profile Builder
   - [ ] Test Coupon Auto-Apply

4. **Test Desktop Browser - Firefox**
   - [ ] Open https://bondsnbeyond.ai in Firefox
   - [ ] Login/Register
   - [ ] Test Profile Builder
   - [ ] Test Coupon Auto-Apply
...
**Solution:**
- Verify `COOKIE_DOMAIN=.bonds n beyond.ai` is set in production
