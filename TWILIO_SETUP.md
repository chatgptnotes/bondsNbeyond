...
This guide explains how to set up Twilio for mobile number verification in Bonds N Beyond NFC.
...
3. Enter a friendly name: `Bonds N Beyond NFC Verification`
4. Click **Create**
...
- Bonds N Beyond NFC: Check project documentation
