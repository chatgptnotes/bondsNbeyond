-- ============================================
-- Fix BONDS N BEYONDFM Voucher Expiration Issue
-- ============================================
...
-- DELETE FROM voucher_usage WHERE voucher_id = (SELECT id FROM vouchers WHERE code = 'BONDS N BEYONDFM');
