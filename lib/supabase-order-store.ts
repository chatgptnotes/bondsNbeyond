...
// Digital Profile + Bonds N Beyond App: LKFM-DPLA-{cryptic}
// NFC Digital Card + Digital Profile + Bonds N Beyond App: LKFM-CDPLA-{cryptic}
export const generateOrderNumber = async (planType: OrderPlanType = 'nfc-card-full'): Promise<string> => {
  ...
  let prefix = 'LKFM-CDPLA'; // Default: NFC Card + Digital Profile + Bonds N Beyond App
