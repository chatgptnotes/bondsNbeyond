...
<head>
  <meta charset="utf-8">
  <title>Order Confirmation - Bonds N Beyond</title>
  ${baseEmailStyles}
</head>
<body>
  <div class="email-container">
    <div class="header">
      ...
      <p class="tagline">Your Bonds N Beyond NFC card is being prepared</p>
    </div>
    ...
    <div class="content">
      ...
      <div class="card-preview">
        ...
        <div class="card-brand">BONDS N BEYOND</div>
      ...
      <div class="order-details">
        ...
        <div class="detail-row">
          <span>Bonds N Beyond NFC Card (Qty: ${data.cardConfig.quantity || 1}):</span>
    ...
    <div class="footer">
      <p>Thank you for choosing Bonds N Beyond!</p>
      <div class="footer-links">
        <a href="https://bondsnbeyond.ai/support">Support</a>
        <a href="https://bondsnbeyond.ai/tracking">Track Order</a>
        <a href="https://bondsnbeyond.ai/account">My Account</a>
      </div>
      <p style="margin-top: 20px; color: #94a3b8; font-size: 12px;">
        © 2025 Bonds N Beyond. All rights reserved.<br>
...
<head>
  <meta charset="utf-8">
  <title>In Production - Bonds N Beyond</title>
  ${baseEmailStyles}
</head>
<body>
  <div class="email-container">
    ...
    <div class="footer">
      <p>Crafted with care by the Bonds N Beyond team</p>
      <div class="footer-links">
        <a href="https://bondsnbeyond.ai/support">Support</a>
        <a href="https://bondsnbeyond.ai/tracking">Track Order</a>
      </div>
...
<head>
  <meta charset="utf-8">
  <title>Order Shipped - Bonds N Beyond</title>
  ${baseEmailStyles}
</head>
<body>
  <div class="email-container">
    ...
    <div class="content">
      ...
      <p>Your Bonds N Beyond NFC card has been carefully packaged and shipped! It's now on its way to you.</p>
    ...
    <div class="footer">
      <p>Almost there! Your Bonds N Beyond card is coming soon.</p>
      <div class="footer-links">
        <a href="${data.trackingUrl || '#'}">Track Package</a>
        <a href="https://bondsnbeyond.ai/support">Support</a>
        <a href="https://bondsnbeyond.ai/activation">Activation Guide</a>
      </div>
    </div>
  </div>
</body>
...
<head>
  <meta charset="utf-8">
  <title>Package Delivered - Bonds N Beyond</title>
  ${baseEmailStyles}
</head>
<body>
  <div class="email-container">
    <div class="header">
      <h1>Your Bonds N Beyond Card Has Arrived! 🎉</h1>
    ...
    <div class="content">
      ...
      <p>Congratulations! Your custom Bonds N Beyond NFC card has been delivered. You're now ready to network like never before.</p>
      ...
      <ol style="color: #64748b;">
        <li><strong>Activate your card:</strong> Visit <a href="https://bondsnbeyond.ai/activate" style="color: #ef4444;">bonds n beyond.ai/activate</a></li>
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="https://bondsnbeyond.ai/activate" class="tracking-button">Activate Your Card</a>
      </div>
      ...
      <ul style="color: #64748b;">
        <li>📱 <a href="https://bondsnbeyond.ai/activation" style="color: #ef4444;">Activation Guide</a> - Step-by-step setup</li>
        <li>💡 <a href="https://bondsnbeyond.ai/tips" style="color: #ef4444;">Networking Tips</a> - Make the most of your card</li>
        <li>🎥 <a href="https://bondsnbeyond.ai/demo" style="color: #ef4444;">Video Tutorial</a> - See it in action</li>
        <li>📞 <a href="https://bondsnbeyond.ai/support" style="color: #ef4444;">Support</a> - We're here to help</li>
      </ul>

      <p>Welcome to the Bonds N Beyond community! We can't wait to see how you'll use your new card to grow your network.</p>
    </div>

    <div class="footer">
      <p>Ready to network differently?</p>
      <div class="footer-links">
        <a href="https://bondsnbeyond.ai/activate">Activate Card</a>
        <a href="https://bondsnbeyond.ai/support">Support</a>
        <a href="https://bondsnbeyond.ai/account">My Account</a>
      </div>
      <p style="margin-top: 20px; color: #94a3b8; font-size: 12px;">
...
<head>
  <meta charset="utf-8">
  <title>Receipt - Bonds N Beyond</title>
  ${baseEmailStyles}
</head>
<body>
  <div class="email-container">
    ...
    <div class="content">
      ...
      <div class="order-details">
        ...
        <div class="detail-row">
          <span>Bonds N Beyond NFC Card - ${data.cardConfig.cardFirstName || data.cardConfig.firstName} ${data.cardConfig.cardLastName || data.cardConfig.lastName}</span>
          <span>$${data.pricing.subtotal.toFixed(2)}</span>
        </div>
        <div class="detail-row">
    ...
    <div class="footer">
      ...
      <div class="footer-links">
        <a href="https://bondsnbeyond.ai/support">Support</a>
        <a href="https://bondsnbeyond.ai/returns">Returns</a>
        <a href="https://bondsnbeyond.ai/account">My Account</a>
      </div>
      <p style="margin-top: 20px; color: #94a3b8; font-size: 12px;">
        Bonds N Beyond, Inc. • Tax ID: 12-3456789 • support@linkist.ai
      </p>
    </div>
  </div>
</body>
...
<body>
  <div class="email-container">
    <div class="header">
      <h1>🖨️ Bonds N Beyond Print Orders</h1>
    ...
    <div class="footer">
      ...
      <p>Generated by Bonds N Beyond System on ${new Date().toLocaleString()}</p>
