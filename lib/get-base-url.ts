...
export function getBaseUrl(): string {
  ...
  // Fallback to bonds n beyond.ai if no env variable is set
  console.warn('NEXT_PUBLIC_SITE_URL not set, using fallback: https://bondsnbeyond.ai');
  return 'https://bondsnbeyond.ai';
}
 ...
 *
 * @returns {string} Base domain without protocol (e.g., "bonds n beyond.ai" or "localhost:3001")
 */
