...
## 1. ✅ Removed Duplicate Bonds N Beyond Logo
**File**: `components/ConditionalLayout.tsx`
- **Issue**: Double Bonds N Beyond logo appearing in top-left corner on NFC pages
...
upi://pay?pa=bonds n beyond@paytm&pn=Bonds N Beyond%20NFC&am=${amount}&cu=USD&tn=NFC%20Card%20Payment
