# Component Specifications - Bonds N Beyond NFC Platform

**Based on Figma Design**: UX Pilot - Bonds N Beyond NFC eCommerce
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-between h-16">
      ...
      <div className="flex items-center gap-2">
        <img src="/logo.svg" alt="Bonds N Beyond" className="h-8 w-8" />
        <span className="text-xl font-bold text-gray-900">Bonds N Beyond</span>
      </div>
...
**See**: `/Users/murali/Downloads/bonds n beyondnfc-main 5/components/PremiumCard.css`
...
**See**: `/Users/murali/Downloads/bonds n beyondnfc-main 5/components/landing/PricingSection.tsx`
