...
function createCard(
  ...
  // Use the Bonds N Beyond card image
  let textureFront = new THREE.TextureLoader().load("/card_bondsnbeyond_black_png.png");
  let textureBack = new THREE.TextureLoader().load("/card_bondsnbeyond_black_png.png");

  if (reversed) {
    // For the second card, you could use a different texture or keep the same
    textureFront = new THREE.TextureLoader().load("/card_bondsnbeyond_black_png.png");
    textureBack = new THREE.TextureLoader().load("/card_bondsnbeyond_black_png.png");
  }
