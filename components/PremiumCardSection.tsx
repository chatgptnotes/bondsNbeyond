  ...
  return (
    <section className="premium-card-section reveal">
      ...
      <div className="card-container">
        <div className="premium-card" id="bondsnbeyondCard">
          ...
          <div className="bondsnbeyond-card-image">
            <img src="/card_bondsnbeyond_black_png.png" alt="Bonds N Beyond Premium Card" />
          </div>
        </div>
