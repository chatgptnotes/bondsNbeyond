...
const testimonials: Testimonial[] = [
  {
    ...
    location: 'Dubai, UAE',
    rating: 5,
    testimonial: 'Bonds N Beyond NFC cards transformed how I network at events. The instant digital connection and professional impression it creates is unmatched. My contact exchanges increased by 300%!',
  ...
  },
  {
    ...
    rating: 5,
    testimonial: 'As a tech entrepreneur, I needed something that matched my innovative approach. Bonds N Beyond NFC cards are the perfect blend of technology and professionalism. Investors love the tech-forward impression.',
    avatar: '/api/placeholder/80/80'
  },
  {
    id: '3',
    ...
    <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Join thousands of professionals who've revolutionized their networking with Bonds N Beyond NFC cards
          </motion.p>
        </motion.div>
