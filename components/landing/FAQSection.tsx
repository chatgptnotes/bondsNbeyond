...
const faqData: FAQItem[] = [
  {
    ...
    answer: "Simply tap your Bonds N Beyond NFC card to any NFC-enabled smartphone and your digital profile will open automatically in their browser. No app installation required - it works instantly with built-in NFC technology."
  },
  {
    question: "Do recipients need the Bonds N Beyond app?",
  ...
  },
  {
    ...
    answer: "Yes! Your digital profile is completely updateable. You can change your contact information, social links, and profile photo anytime through your Bonds N Beyond dashboard. The card itself doesn't need to be replaced."
  },
  {
  ...
  },
  {
    ...
    answer: "The Bonds N Beyond mobile app is coming in 2026 and will include advanced analytics, contact management, lead tracking, and enhanced customization options. Current features are accessible through our web dashboard."
  }
];
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Everything you need to know about Bonds N Beyond NFC cards
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Our support team is here to help you get the most out of your Bonds N Beyond NFC card.
            </p>
            <motion.a
