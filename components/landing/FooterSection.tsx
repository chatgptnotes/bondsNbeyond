...
const FooterSection = () => {
  ...
  const socialLinks = [
    { href: 'https://linkedin.com/company/bondsnbeyond-nfc', icon: Linkedin, label: 'LinkedIn' },
    { href: 'https://twitter.com/bondsnbeyondnfc', icon: Twitter, label: 'Twitter' },
    { href: 'https://instagram.com/bondsnbeyondnfc', icon: Instagram, label: 'Instagram' },
        ...
        >
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-gray-400 text-sm">
              <p>
                © {currentYear} Bonds N Beyond NFC. All rights reserved.
              </p>
