...
class App {
  ...
  initCards(px: number, py: number, pz: number, name: string, reversed: boolean) {
    ...
    let textureFront = new window.THREE.TextureLoader().load("/card_bondsnbeyond_black_png.png");
    let textureBack = new window.THREE.TextureLoader().load("/bondsnbeyond_Card_Mockup.png");

    if (reversed) {
      textureFront = new window.THREE.TextureLoader().load("/bondsnbeyond_Card_Mockup.png");
      textureBack = new window.THREE.TextureLoader().load("/card_bondsnbeyond_black_png.png");
    }
