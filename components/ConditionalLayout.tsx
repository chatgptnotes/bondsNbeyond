...
export default function ConditionalLayout({ children }: ConditionalLayoutProps) {
  ...
  const isInnerPage = pathname.startsWith('/checkout') ||
                      ...
                      pathname.startsWith('/welcome-to-bondsnbeyond') ||
                      pathname.startsWith('/verify-mobile') ||
                      pathname.startsWith('/verify-login') ||
  ...
  const knownRoutes = ['/admin', '/api', '/checkout', '/confirm-payment', '/thank-you', '/account',
                       '/profile-dashboard', '/verify-email', '/nfc', '/product-selection', '/paintings', '/choose-plan',
                       '/welcome-to-bondsnbeyond', '/verify-mobile', '/verify-login', '/login', '/register',
