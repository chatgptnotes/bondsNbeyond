# 📧 Gmail Email Setup Guide - Bonds N Beyond NFC
...
Open `/Users/apple/Downloads/bonds n beyondnfc-main 4/.env.local` and add:

```bash
# Gmail SMTP Configuration
GMAIL_FROM=Bonds N Beyond <chatgptnotes@gmail.com>
...
**From:** `Bonds N Beyond <chatgptnotes@gmail.com>`
**To:** Customer's email (e.g., `bb@gmail.com`)
**Subject:** `Your Bonds N Beyond NFC Order is Confirmed – NFC-[timestamp]`

**Body includes:**
- Professional Bonds N Beyond branding
...
```bash
cd "/Users/apple/Downloads/bonds n beyondnfc-main 4"
node -e "
