...
('site_name', '"Bonds N Beyond NFC Admin Dashboard"', 'general', 'Site name for admin dashboard'),
...
('email_from_name', '"Bonds N Beyond NFC"', 'email', 'Default sender name for emails'),
('email_from_address', '"noreply@linkist.com"', 'email', 'Default sender email address'),
('email_footer_text', '"© 2025 Bonds N Beyond NFC. All rights reserved."', 'email', 'Email footer text'),
...
(
    'Order Confirmation',
    'Your Bonds N Beyond NFC Order #{{order_number}} is Confirmed',
...
(
    ...
    'Your Bonds N Beyond NFC Order #{{order_number}} has Shipped',
