...
### Production (✅ Deployed)
- **URL**: https://bonds n beyond.2men.co
- **Status**: ● Ready
- **Deployment**: https://bonds n beyond29sep2025-holuakei8-chatgptnotes-6366s-projects.vercel.app
...
EMAIL_FROM=Bonds N Beyond <noreply@linkist.ai>
EMAIL_REPLY_TO=support@linkist.ai
NODE_ENV=production  # Controls devOtp visibility
```

### Email Template
- **Branded HTML**: Bonds N Beyond NFC gradient header
...
- **GitHub**: https://github.com/chatgptnotes/bonds n beyond29sep2025
- **Production**: https://bonds n beyond.2men.co
