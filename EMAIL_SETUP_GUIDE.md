# 📧 Email Configuration Guide - Bonds N Beyond NFC
...
Open `/Users/apple/Downloads/bonds n beyondnfc-main 4/.env.local` and update:
...
**Subject:** `Order Confirmed - NFC-[timestamp] | Bonds N Beyond`
