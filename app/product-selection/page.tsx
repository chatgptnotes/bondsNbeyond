...
export default function ProductSelectionPage() {
  ...
  const getDefaultPlans = (): ProductOption[] => {
    ...
    return [
      {
        id: 'physical-digital',
        title: 'Physical NFC Card + Bonds N Beyond App',
        ...
        features: [
          'Premium NFC Card',
          'Bonds N Beyond App Access (1 Year)',
          'AI Credits worth $50',
      ...
      {
        id: 'digital-with-app',
        title: 'Digital Profile + Bonds N Beyond App',
        subtitle: '1 year subscription & AI Credits',
        price: '$19',
        priceLabel: 'Best Value',
        icon: <Smartphone className="w-6 h-6" />,
  ...
  const handleConfirmSelection = async () => {
    ...
    if (selectedProduct === 'digital-only') {
      ...
      // Digital Profile + Bonds N Beyond App → Payment page directly
      setTimeout(() => {
        const userProfile = localStorage.getItem('userProfile');
        let email = '';
        let firstName = 'User';
        ...
        const digitalOrder = {
          ...
          email,
          phoneNumber,
          productName: 'Digital Profile + Bonds N Beyond App',
          cardConfig: {
            firstName,
            lastName,
            baseMaterial: 'digital',
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 flex-grow">
        ...
        <div className="text-center mb-8 md:mb-12">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 px-4">
            Choose Your Bonds N Beyond Experience
          </h1>
