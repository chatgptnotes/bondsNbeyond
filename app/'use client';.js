  ...
  return (
    <section className="highlights-section reveal">
      ...
      <div className="background-logo">
        <img src="/logo_bondsnbeyond.png" alt="" className="floating-logo" />
      </div>
    ...
    <section className="design-section reveal">
      ...
      <div className="floating-logos">
        <div className="floating-logo" style={{left: '10%', top: '20%', animationDelay: '0s'}}>
          <img src="/favicon-16x16.png" alt="Bonds N Beyond" />
        </div>
      ...
      <div className="design-content">
        <div className="design-header">
          ...
          <h2 className="design-title">Bonds N Beyond Card.<br />Makes a strong case for itself.</h2>
          <p className="design-description">
            Introducing Bonds N Beyond Card, designed from the inside out to be the most powerful payment card ever made. 
            At the core of the new design is a premium aluminum construction that maximizes security, durability, and style.
          </p>
        </div>
        
        <div className="bondsnbeyond-card-display">
          <CardShowcase />
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .bondsnbeyond-card-front,
        .bondsnbeyond-card-back {
          position: absolute;
          width: 100%;
          height: 100%;
        ...
        <div className="what-you-get-text">
          ...
          <div className="features-list">
            ...
            <div className="feature-item">
              <div className="feature-icon"></div>
              <div className="feature-content">
                <h3>Personal Bonds N Beyond Profile</h3>
                <p>
...
const DesignSection: React.FC = () => {
  ...
  return (
    <section className="design-section reveal">
      ...
      <div className="design-content">
        <div className="bondsnbeyond-card-3d-container">
          
          {/* Enhanced 3D Card */}
          <div 
            ref={cardRef}
            className="bondsnbeyond-card-3d"
            onMouseMove={handleCardHover}
            onMouseLeave={handleCardLeave}
            onClick={handleCardClick}
          >
            {/* Video Background */}
            <video className="bondsnbeyond-video" autoPlay muted loop playsInline>
              <source src="/video_bondsnbeyond.mp4" type="video/mp4" />
              Your browser does not support the video tag.
            </video>
            
            {/* Multiple Glow Layers */}
            <div className="bondsnbeyond-glow primary-glow"></div>
            <div className="bondsnbeyond-glow secondary-glow"></div>
            <div className="bondsnbeyond-glow accent-glow"></div>
        ...
        <div className="design-header">
          ...
          <h2 className="design-title">
            Bonds N Beyond Card.<br />
            <span className="title-highlight">Redefining Premium Banking</span>
          </h2>
          <p className="design-description">
            Experience the future of financial technology with Bonds N Beyond Card. Crafted with aerospace-grade aluminum and 
      ...
      <style jsx>{`
        ...
        .bondsnbeyond-card-3d-container {
          position: relative;
          display: flex;
          justify-content: center;
          align-items: center;
        ...
        .bondsnbeyond-card-inner.flipped {
          transform: rotateY(180deg);
        }
      ...
      <div className="center-stage-content">
        <div className="center-stage-text">
          ...
          <p className="center-stage-description">
            The new Bonds N Beyond Card gives you flexible ways to manage your finances — and so 
        ...
        <div className="center-stage-demo">
          ...
          <button className="compare-cameras-front">Compare Bonds N Beyond Cards +</button>
        </div>
      </div>
  ...
  return (
    <section className="hero-section">
      <div className="hero-content">
        ...
        >
          <source src="/video_bondsnbeyond2.mp4" type="video/mp4" />
        </video>
      </div>
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Premium Bonds N Beyond Card Section */}
      <PremiumCardSection />
        ...
        <div className="footer-content">
          <div className="footer-grid">
            <div className="footer-section">
              <h3>Products</h3>
              <ul>
                <li><Link href="#">Bonds N Beyond Card</Link></li>
            ...
            <div className="footer-section">
              <h3>Company</h3>
              <ul>
                <li><Link href="#">About Bonds N Beyond</Link></li>
          ...
          <div className="footer-bottom">
            <div className="footer-logo">Bonds N Beyond</div>
            ...
            <div className="footer-copyright">
              © 2025 Bonds N Beyond Inc. All rights reserved. FDIC Insured.
            </div>
          </div>
        </div>
      </footer>
      ...
      <style jsx global>{`
        /* Bonds N Beyond Design System Variables */
        :root {
          --apple-orange: #FF8B00;
