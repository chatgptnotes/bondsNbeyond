    ...
    setTimeout(() => {
      setCommunications([
        ...
        },
        {
          id: '2',
          type: 'email',
          subject: 'Welcome to Bonds N Beyond',
          recipient: 'jane.smith@example.com',
          status: 'sent',
          sentAt: '2024-01-29T09:15:00Z',
          message: 'Welcome to Bonds N Beyond! Your account has been created successfully.'
        },
        {
          id: '3',
          type: 'sms',
          ...
          status: 'pending',
          message: 'Your Bonds N Beyond NFC card has been shipped. Track: ABC123'
        },
        {
          id: '4',
          type: 'email',
          ...
          message: 'Password reset request for your Bonds N Beyond account.'
        }
      ]);
      ...
      setTemplates([
        ...
        },
        {
          ...
          type: 'email',
          subject: 'Welcome to Bonds N Beyond',
          content: 'Welcome {{customerName}}! Thank you for joining Bonds N Beyond...',
          usageCount: 89
        },
        {
          id: '3',
