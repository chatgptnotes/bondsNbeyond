...
export default function WelcomeToBondsNBeyond() {
    ...
    <>
      <div className="bg-gray-50 flex items-center justify-center py-20 px-4 min-h-screen">
        ...
        <div className="text-center mb-4">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">Welcome to Bonds N Beyond</h1>
