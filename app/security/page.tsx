        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              At Bonds N Beyond, we take security seriously. We implement industry-standard security measures
          ...
          <section>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <ul className="text-sm text-green-700 space-y-2">
                <li>✓ Use a strong, unique password for your Bonds N Beyond account</li>
                <li>✓ Enable two-factor authentication (2FA)</li>
                <li>✓ Never share your login credentials with anyone</li>
                <li>✓ Log out from shared or public devices</li>
                <li>✓ Keep your email account secure</li>
                <li>✓ Be cautious of phishing emails claiming to be from Bonds N Beyond</li>
