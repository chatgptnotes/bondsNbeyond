...
export default function ChoosePlanPage() {
  ...
  const handlePersonalUse = () => {
    router.push('/welcome-to-bondsnbeyond');
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Prefilled message
    const message = `I need to buy multiple Bonds N Beyond Digital cards for my team, please contact me to discuss.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="text-center flex-grow flex flex-col">
              ...
              <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-6 flex-grow">
                I want to get Bonds N Beyond privileges for myself
              </p>
              <button
          ...
          >
            <div className="text-center flex-grow flex flex-col">
              ...
              <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-6 flex-grow">
                I need Bonds N Beyond privileges for my team
              </p>
              <button
