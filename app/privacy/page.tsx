        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              At Bonds N Beyond ("we," "our," or "us"), we respect your privacy and are committed to protecting 
          ...
          <section>
            ...
            <div className="bg-red-50 rounded-lg p-6">
              ...
              <div className="space-y-2 text-red-800">
                ...
                <p><strong>Privacy Portal:</strong> <Link href="/privacy/manage" className="underline">bondsnbeyond.ai/privacy/manage</Link></p>
              </div>
