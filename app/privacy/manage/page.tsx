...
export default function PrivacyManagePage() {
  ...
  const handleDataExport = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `bondsnbeyond-data-export-${email.replace('@', '-at-')}-${new Date().toISOString().slice(0, 10)}.json`;
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Enter the email address associated with your Bonds N Beyond account to manage your privacy settings.
              </p>
            </div>
          </div>
        </div>
