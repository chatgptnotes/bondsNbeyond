  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Redirect to paintings page for new users (same as mobile verification)
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <Link href="/" className="flex items-center space-x-3">
            <img src="/logo.svg" alt="Bonds N Beyond" className="h-10" />
          </Link>
        </div>
      ...
      <div className="mt-6 text-center">
        <Link href="/welcome-to-bondsnbeyond" className="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
