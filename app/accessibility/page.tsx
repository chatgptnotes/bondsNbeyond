        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              At Bonds N Beyond, we're committed to ensuring digital accessibility for people with disabilities.
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Bonds N Beyond is committed to complying with applicable accessibility laws and regulations,
