        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Welcome to Bonds N Beyond ("we," "our," or "us"). These Terms of Service ("Terms") govern your 
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Bonds N Beyond provides NFC (Near Field Communication) business cards and related services, including:
              </p>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div>
                ...
                <p>
                  The Service and its content, features, and functionality are owned by Bonds N Beyond and are 
          ...
          <section>
            ...
            <div className="bg-gray-100 border border-gray-200 rounded-lg p-6">
              <p className="text-gray-800">
                In no event shall Bonds N Beyond, its directors, employees, partners, agents, suppliers, or affiliates 
          ...
          <section>
            ...
            <p className="text-gray-700">
              You agree to defend, indemnify, and hold harmless Bonds N Beyond from any loss, damage, liability, 
