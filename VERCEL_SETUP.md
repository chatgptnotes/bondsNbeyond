...
2. Select your project: `BONDS N BEYOND_31Oct`
...
NEXT_PUBLIC_APP_NAME=Bonds N Beyond NFC
...
EMAIL_FROM=Bonds N Beyond NFC <hello@linkist.ai>
...
- For production: Use your actual domain (e.g., `https://bondsnbeyond.ai`)
- For Vercel deployment: Use your Vercel URL (e.g., `https://bonds n beyond-31oct.vercel.app`)
