...
- BONDS N BEYONDFM voucher validity: November 1, 2025 - May 1, 2026
...
```typescript
  ...
  // Validation failed
  console.error('❌ BONDS N BEYONDFM validation failed:', voucherData?.message);
...
**Voucher Validation:**
- [ ] New founding member can apply BONDS N BEYONDFM voucher
...
3. **Test new user signup:**
   ...
   - Test BONDS N BEYONDFM voucher application
...
- BONDS N BEYONDFM voucher: Not yet valid

**Nov 2025 - May 2026:**
- New signups: `is_founding_member = true`
- BONDS N BEYONDFM voucher: Valid and applies correctly
...
**After May 2026:**
- New signups: `is_founding_member = false`
- BONDS N BEYONDFM voucher: Expired
